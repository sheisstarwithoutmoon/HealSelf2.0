...
import { patientSignup, PatientSignupData } from '@/utils/api'
...
export default function SignUpPatient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage('Patient signup successful! Check your email for the password.');
      // Reset form
          ...
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <form onSubmit={handleSubmit} className="mt-12">
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                    />
                    {errors.patient_email && <p className="text-red-500 text-sm mt-1">{errors.patient_email}</p>}
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2 mb-12">
                    <input
                      ...
                      max="120"
                    />
                    {errors.patient_age && <p className="text-red-500 text-sm mt-1">{errors.patient_age}</p>}
                  </div>
                </div>
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="inline-flex w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-black/80 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                {message && (
                  <div className={`text-center text-sm mt-4 ${message.includes('successful') ? 'text-green-600' : 'text-red-600'}`}>
                    {message}
                  </div>
                )}
              </div>
