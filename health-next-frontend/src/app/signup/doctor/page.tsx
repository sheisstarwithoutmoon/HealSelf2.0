...
import { doctorSignup, DoctorSignupData } from '@/utils/api'
...
export default function SignUpDoctor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage('Doctor signup successful! Check your email for the password.');
      // Reset form
                ...
                <div>
                  ...
                  <div className="mt-2 mb-12">
                    <input
                      ...
                      required
                    />
                    {errors.specialisation && <p className="text-red-500 text-sm mt-1">{errors.specialisation}</p>}
                  </div>
                </div>
                <div>
                  <button
